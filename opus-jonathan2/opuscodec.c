...
__attribute__((annotate("as3sig:public function _wrap_opusenc(inFile:String, outFile:String):int")))
void _wrap_opusenc() {
  char *arg1 = (char *) 0 ;
  char *arg2 = (char *) 0 ;
  int result ;
  ...
  {
    AS3_MallocString(arg1, inFile);
  }
  {
    AS3_MallocString(arg2, outFile);
  }
  result = (int)opusenc(arg1,arg2);
  {
    free(arg1);
  }
  {
